...
#define ROHM_VAL_5               5
#define ROHM_VAL_6               6
#define ROHM_VAL_10              10
#define ROHM_VAL_16              16
#define ROHM_VAL_32              32
#define ROHM_VAL_100             100
#define ROHM_VAL_160             160
#define ROHM_VAL_200             200
#define ROHM_VAL_234             234
#define ROHM_VAL_246             246
#define ROHM_VAL_320             320
#define ROHM_VAL_423             423
#define ROHM_VAL_512             512
#define ROHM_VAL_640             640
#define ROHM_VAL_1000            1000
#define ROHM_VAL_1280            1280
#define ROHM_VAL_2227            2227
#define ROHM_VAL_2399            2399
#define ROHM_VAL_2560            2560
#define ROHM_VAL_5120            5120
#define ROHM_VAL_9000            9000
#define ROHM_VAL_10000           10000
#define ROHM_VAL_0X02            (0x02)
#define ROHM_VAL_0X03            (0x03)
#define ROHM_VAL_0X07            (0x07)
#define ROHM_VAL_0X0B            (0x0b)
#define ROHM_VAL_0X3F            (0x3f)
#define ROHM_VAL_0X50            (0x50)
#define ROHM_VAL_0X55            (0x55)
#define ROHM_VAL_0XFF            (0xFF)

#define ROHM_POWER_DELAY_OFF     1
#define ROHM_ALS_POLL_DELAY      350
#define ROHM_DEBUG_MASK          1
#define ROHM_LUX_VAL_10          10
#define ROHM_LUX_VAL_20          20
#define ROHM_LUX_VAL_30          30
#define ROHM_LUX_VAL_50          50
#define ROHM_LUX_VAL_75          75
#define ROHM_LUX_VAL_200         200
#define ROHM_PREV_LUX            300
#define ROHM_LUX_VAL_400         400
#define ROHM_LUX_VAL_800         800
#define ROHM_LUX_VAL_1500        1500
#define ROHM_LUX_VAL_3000        3000
#define ROHM_LUX_VAL_5000        5000
#define ROHM_LUX_VAL_8000        8000
#define ROHM_LUX_VAL_10000       10000
#define ROHM_LUX_VAL_1000000     1000000

#define ROHM_ARR_SIZE_2          2
#define ROHM_ARR_SIZE_3          3
#define ROHM_ARR_SIZE_6          6

#define ROHM_ERR_LOG             0
#define ROHM_INFO_LOG            1
#define ROHM_FLOW_LOG            2

#define ROHM_FUNC_FAIL           (-1)

#define ROHM_ALS_ENABLE          1
#define ROHM_LIGHT_OPEN_ENABLE   1
#define ROHM_VALID_FLAG          (0xffff)
#define ROHM_RIGHT_SHIFT_16      16
#define ROHM_RIGHT_SHIFT_24      24
...
#endif
static unsigned short bh1745_atime[ROHM_ARR_SIZE_6] = {ROHM_VAL_160, ROHM_VAL_320, ROHM_VAL_640, ROHM_VAL_1280, ROHM_VAL_2560, ROHM_VAL_5120};
static unsigned char bh1745_again[ROHM_ARR_SIZE_3] = {ROHM_VAL_1, ROHM_VAL_2, ROHM_VAL_16};
static int dim_flag = 0;
static int rohm_power_delay_flag = ROHM_POWER_DELAY_OFF;   /* 1 not always on ,0 always on*/
static long cofficient_judge = ROHM_VAL_246;
static long cofficient_red[ROHM_ARR_SIZE_2]={ROHM_VAL_423, ROHM_VAL_234};
static long cofficient_green[ROHM_ARR_SIZE_2] = {ROHM_VAL_2399, ROHM_VAL_2227};
static long cofficient_blue[ROHM_ARR_SIZE_2] = {0,0};
enum tp_color_id{
	GOLD = 0,
	WHITE,
	BLACK,
...
static unsigned int  lux_arr[] = {ROHM_LUX_VAL_10, ROHM_LUX_VAL_20,ROHM_LUX_VAL_30,ROHM_LUX_VAL_50,
                                  ROHM_LUX_VAL_75,ROHM_LUX_VAL_200,ROHM_LUX_VAL_400, ROHM_LUX_VAL_800, 
								  ROHM_LUX_VAL_1500, ROHM_LUX_VAL_3000,ROHM_LUX_VAL_5000,ROHM_LUX_VAL_8000,ROHM_LUX_VAL_10000};
...
static int rgb_bh1745_debug_mask= ROHM_DEBUG_MASK;

static int als_calibrate_flag = 0;//uint8
static int als_calibrate_count = 0;//uint8
static long calibrate_total_data[ROHM_ARR_SIZE_6] = {0};//32
static long calibrate_average_data[ROHM_ARR_SIZE_6] = {0};//uint16

static int auto_light_open_flag = 0;
static long calibrate_object_data_from_kernel[ROHM_ARR_SIZE_6] = {ROHM_VAL_1000,ROHM_VAL_1000, ROHM_VAL_1000,
                                                                  ROHM_VAL_1000,ROHM_VAL_1000,ROHM_VAL_1000};//uint16
static long bh1745_als_offset[ROHM_ARR_SIZE_6] = {ROHM_VAL_1000, ROHM_VAL_1000, ROHM_VAL_1000, 
                                                  ROHM_VAL_1000, ROHM_VAL_1000, ROHM_VAL_1000};//uint16
static long als_ratio_max = ROHM_VAL_9000*ROHM_VAL_1000;
...
#define BH1745_ERR(x...) do {\
    if (rgb_bh1745_debug_mask >=ROHM_ERR_LOG) \
        printk(KERN_ERR x);\
    } while (0)

#define BH1745_INFO(x...) do {\
    if (rgb_bh1745_debug_mask >=ROHM_INFO_LOG) \
        printk(KERN_ERR x);\
    } while (0)
#define BH1745_FLOW(x...) do {\
    if (rgb_bh1745_debug_mask >=ROHM_FLOW_LOG) \
        printk(KERN_ERR x);\
    } while (0)
#ifdef CONFIG_HUAWEI_DSM
...
struct tp_lx_cal_parameter tp_module_parameter[MODULE_MANUFACTURE_NUMBER] = {{.tp_module_id = ROHM_VAL_0X55},{.tp_module_id = ROHM_VAL_0X55},
                                                                             {.tp_module_id = ROHM_VAL_0X55},{.tp_module_id = ROHM_VAL_0X55},
																			 {.tp_module_id = ROHM_VAL_0X55},{.tp_module_id = ROHM_VAL_0X55}};
...
static struct sensors_classdev sensors_light_cdev = {
	...
	.resolution = "0.0125",
	.sensor_power = "0.20",
	.min_delay = ROHM_VAL_1000, /* in microseconds */
	.fifo_reserved_event_count = 0,
	.fifo_max_event_count = 0,
	.enabled = 0,
	.delay_msec = ROHM_VAL_100,
	.sensors_enable = NULL,
...
static int bh1745_i2c_exception_status(struct rgb_bh1745_data *data)
{
	...
	excep->vdd_mv = regulator_get_voltage(data->vdd)/ROHM_VAL_1000;
	if(excep->vdd_mv < 0){
		BH1745_ERR("%s,line %d:regulator_get_voltage vdd failed\n",__func__,__LINE__);
	}

	excep->vio_mv = regulator_get_voltage(data->vio)/ROHM_VAL_1000;
	if(excep->vio_mv < 0){
...
static int bh1745_dsm_init(struct rgb_bh1745_data *data)
{
	...
	data->als_test_exception.reg_buf = kzalloc(ROHM_VAL_512, GFP_KERNEL);
						...
						const char *buf, size_t count)
{
	...
	if (strict_strtol(buf, ROHM_VAL_10, &mode))
			return -EINVAL;
...
static int rgb_bh1745_calc_lx(struct i2c_client *client, struct rgb_bh1745_rgb_data *data, unsigned char gain, unsigned short itime)
{
	...
	lx_tmp = div_s64(lx_tmp,gain/ROHM_VAL_16);
	lx_tmp = div_s64(lx_tmp,itime/ROHM_VAL_160);
	lx_tmp = div_s64(lx_tmp, ROHM_VAL_1000);
	lx = lx_tmp;
	...
	else
	{
		for(i = 0;i < ROHM_VAL_6; i++)
		{
			if(calibrate_total_data[i] < BH1745_ALS_CALIBRATE_COUNT)
			{
				...
				bh1745_als_offset[0]=ROHM_VAL_1000;
				bh1745_als_offset[1]=ROHM_VAL_1000;
				bh1745_als_offset[2]=ROHM_VAL_1000;
				bh1745_als_offset[3]=ROHM_VAL_1000;
				bh1745_als_offset[4]=ROHM_VAL_1000;
				bh1745_als_offset[5]=ROHM_VAL_1000;
				status = ROHM_FUNC_FAIL;
				break;
			}
			else
			{
				...
				bh1745_als_offset[i]=(calibrate_object_data_from_kernel[i]*ROHM_VAL_1000)/calibrate_average_data[i];
...
static void rgb_bh1745_als_polling_work_handler(struct work_struct *work)
{
	...
	if((ret & ROHM_VAL_0XFF) != ROHM_VAL_0X02)
	{
		...
		data->enable_als_sensor = ROHM_ALS_ENABLE;
	...
	else
	{
		...
		if(als_calibrate_flag == true)
		{
			...
			calibrate_data[5] =ROHM_VAL_1000;// light_data.cct;
			als_calibrate(calibrate_data);
		}
#ifdef BH1745_USE_CALIBRATE_PARA
		data->rgb_data.red=bh1745_als_offset[0]*data->rgb_data.red/ROHM_VAL_1000;
		data->rgb_data.green=bh1745_als_offset[1]*data->rgb_data.green/ROHM_VAL_1000;
		data->rgb_data.blue=bh1745_als_offset[2]*data->rgb_data.blue/ROHM_VAL_1000;
		data->rgb_data.clear=bh1745_als_offset[3]*data->rgb_data.clear/ROHM_VAL_1000;
#endif
	...
	if( als_polling_count < ROHM_VAL_5 )
	{
		if(luxValue == BH1745_LUX_MAX)
		{
			luxValue = luxValue - als_polling_count%ROHM_VAL_2;
		}
		else
		{
			luxValue = luxValue + als_polling_count%ROHM_VAL_2;
...
restart_timer:
	if (0 != hrtimer_start(&data->timer,
							ktime_set(0, data->als_poll_delay * ROHM_LUX_VAL_1000000), HRTIMER_MODE_REL) )
	{
...
static int rgb_bh1745_enable_als_sensor(struct i2c_client *client, int val)
{
	...
	if (val == ROHM_VAL_1) {
		...
		if (data->enable_als_sensor == 0) {
			...
			ret = hrtimer_start(&data->timer, ktime_set(0, FAST_REPORT_INTERVAL * ROHM_LUX_VAL_1000000), HRTIMER_MODE_REL);
			fast_report = 0;
			if (ret != 0) {
				BH1745_ERR("%s: hrtimer_start fail! nsec=%d\n", __func__, data->als_poll_delay);
			}
		 ...
		 */
		 if(data->enable_als_sensor == ROHM_ALS_ENABLE)
		 {
		...
		unsigned int enable)
{
	...
	if ((enable != 0) && (enable != ROHM_ALS_ENABLE)) {
	...
	if(enable == 0)
	{
		...
		if(rgb_bh1745_debug_mask >= ROHM_DEBUG_MASK){
		...
		unsigned int val)
{
	...
	if (val < ROHM_VAL_10)
		val = ROHM_VAL_10;
	data->als_poll_delay = ROHM_ALS_POLL_DELAY;
	...
	cancel_work_sync(&data->als_dwork);
	hrtimer_cancel(&data->timer);
	ret = hrtimer_start(&data->timer, ktime_set(0, data->als_poll_delay * ROHM_LUX_VAL_1000000), HRTIMER_MODE_REL);
	if (ret != 0) {
			...
			struct device_attribute *attr, char *buf)
{
	...
	return snprintf(buf,ROHM_VAL_32,"%d\n", red_data);
}
			...
			struct device_attribute *attr, char *buf)
{
	if (NULL == buf) {
 	...
 	return snprintf(buf,ROHM_VAL_32,"%ld %ld %ld %ld %ld %ld\n",bh1745_als_offset[0],bh1745_als_offset[1],bh1745_als_offset[2],bh1745_als_offset[3],bh1745_als_offset[4],bh1745_als_offset[ROHM_VAL_5]);
}
						...
						const char *buf, size_t count)
{
	...
	if (NULL == data) {
 	...
 	if(x0==ROHM_VAL_1)
 	{
		...
		if(ROHM_ALS_ENABLE != data->enable_als_sensor)
		{
			rgb_bh1745_enable_als_sensor(data->client, ROHM_ALS_ENABLE);
		}
		else
		{
			auto_light_open_flag = ROHM_LIGHT_OPEN_ENABLE;   //auto light open
		}
 	}
 	else if (x0 == 0)
 	{
		if(ROHM_LIGHT_OPEN_ENABLE != auto_light_open_flag)     //auto light close
		{
...
{
	struct i2c_client *client = NULL;
	int val_len_max = ROHM_VAL_4;
	char* input_str =NULL;
	char reg_addr_str[ROHM_VAL_10]={'\0'};
	char reg_val_str[ROHM_VAL_10]={'\0'};
	long reg_addr = 0;
	long reg_val = 0;
	int addr_lenth = 0;
	int value_lenth = 0;
	...
	snprintf(input_str, ROHM_VAL_10,"%s", buf);
	...
	ret = kstrtol(reg_addr_str,ROHM_VAL_16,&reg_addr);
	if(ret)
		goto parse_fail_exit;

	ret = kstrtol(reg_val_str,ROHM_VAL_16,&reg_val);
	if(ret)
		goto parse_fail_exit;
			...
			struct device_attribute *attr, char *buf)
{
	...
	for(i = 0; i < BH1745_REG_LEN; i++ )
	{
		reg[i] = rgb_bh1745_i2c_read(client, (ROHM_VAL_0X50+i), BH1745_I2C_BYTE);
		if(reg[i] <0){
			BH1745_ERR("%s,line %d:read %d reg failed\n",__func__,__LINE__,i);
			return reg[i] ;
		}
	...
	return snprintf(buf,ROHM_VAL_512,"reg[0x0~0x8]=0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x, 0x%2x\n"
			"reg[0x09~0x11]0x%2x\n",
						...
						const char *buf, size_t count)
{
	...
	valid_flag = val & ROHM_VALID_FLAG;
	pdata->panel_id = (val >> ROHM_RIGHT_SHIFT_16) & ROHM_VAL_0XFF;
	pdata->tp_color = (val >> ROHM_RIGHT_SHIFT_24) & ROHM_VAL_0XFF;
			...
			struct device_attribute *attr, char *buf)
{
	...
	strncat(buf,s_buf,ROHM1745_PARA_HEAD_LEN+ROHM_VAL_1);
	for(i=0;i<MODULE_MANUFACTURE_NUMBER;i++)
	{
...
static int rgb_bh1745_resume(struct i2c_client *client)
{
	...
	if (data->enable_als_state) {
		ret = rgb_bh1745_enable_als_sensor(data->client, ROHM_ALS_ENABLE);
		if (ret){
...
static void rgb_bh1745_parameter_init(struct rgb_bh1745_data *data)
{
	...
	data->als_poll_delay = ROHM_ALS_POLL_DELAY;	// default to 320ms
	data->als_prev_lux = ROHM_PREV_LUX;
	pdata->panel_id = ROHM_FUNC_FAIL;
	pdata->tp_color = ROHM_FUNC_FAIL;
}
...
static int rgb_bh1745_input_init(struct rgb_bh1745_data *data)
{
	...
	input_set_abs_params(data->input_dev_als, ABS_MISC, 0, ROHM_VAL_10000, 0, 0);
...
enable_delay:
	...
	if(ROHM_POWER_DELAY_OFF == rohm_power_delay_flag)
	{
		msleep(ROHM_VAL_10);
	}
		...
		struct rgb_bh1745_platform_data *pdata)
{
	...
	if ((NULL == dev) || (NULL == dev->of_node) || (NULL == pdata)) {
		BH1745_ERR("%s: dev or of_node ptr is NULL\n", __func__);
		return -EINVAL;
	}
	...
	if (rc) {
		...
		rohm_power_delay_flag = ROHM_POWER_DELAY_OFF;
	}
	else {
	...
	for(i=0; i<tp_moudle_count; i++){
		...
		for(index = 0; index < array_len; index++){
			...
			ptr[index]  = simple_strtol(raw_data0_dts, NULL, ROHM_VAL_10);
				   ...
				   const struct i2c_device_id *id)
{
	...
	if (!err)
	{
		BH1745_ERR("%s: set_hw_dev_detect_result fail.\n", __func__);
	}
#endif
	/*
