...
EXPORT_SYMBOL_GPL(ana_hs_pluged_state);
...
EXPORT_SYMBOL_GPL(ana_hs_support_usb_sw);
...
EXPORT_SYMBOL_GPL(ana_hs_codec_dev_register);
...
void ana_hs_plug_handle(int hs_state)
{
	...
	hwlog_info("%s: AUDIO %s\n", __func__, hs_state ? "ATTACHED" : "DETACHED");
...
EXPORT_SYMBOL_GPL(ana_hs_plug_handle);
...
EXPORT_SYMBOL_GPL(ana_hs_mic_gnd_swap);
