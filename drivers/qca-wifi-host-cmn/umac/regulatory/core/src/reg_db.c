...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(ANDORRA, ETSI3_WORLD, 0, AD, 40, 160, 0, 0),
	CE(ANGUILLA, ETSI1_WORLD, 0, AI, 40, 160, 0, 0),
	CE(ANTIGUA_AND_BARBUDA, ETSI1_WORLD, 0, AG, 40, 160, 0, 0),
	CE(ARGENTINA, APL16_ETSIC, 0, AR, 40, 160, 0, 0),
	CE(ARMENIA, ETSI4_WORLD, 0, AM, 40, 20, 0, 0),
	...
	CE(BAHRAIN, APL15_WORLD, 0, BH, 40, 20, 0, 0),
	...
	CE(BOLIVIA, APL8_WORLD, 0, BO, 40, 160, 0, 0),
	CE(BOSNIA_HERZ, ETSI1_WORLD, 0, BA, 40, 160, 0, 0),
	CE(BRAZIL, FCC3_ETSIC, 0, BR, 40, 160, 0, 0),
	CE(BRUNEI_DARUSSALAM, APL6_WORLD, 0, BN, 40, 160, 0, 0),
	...
	CE(ECUADOR, FCC3_WORLD, 0, EC, 40, 20, 0, 0),
	CE(EGYPT, ETSI3_WORLD, 0, EG, 40, 160, 0, 0),
	CE(EL_SALVADOR, FCC1_WORLD, 0, SV, 40, 20, 0, 0),
	...
	CE(KOREA_ROC, APL9_MKKC, APL1_6G, KR, 40, 160, 0, 0),
	CE(KUWAIT, ETSI3_WORLD, 0, KW, 40, 160, 0, 0),
	...
	CE(NIGERIA, APL8_WORLD, 0, NG, 40, 160, 0, 0),
	...
	CE(SRI_LANKA, FCC3_WORLD, 0, LK, 40, 20, 0, 0),
	...
	CE(UNITED_KINGDOM, ETSI1_WORLD, ETSI2_6G, GB, 40, 160, 0, 0),
	CE(UNITED_STATES, FCC8_FCCA, FCC1_6G, US, 40, 160, 0, 0),
	...
	CE(YEMEN, FCC3_WORLD, 0, YE, 40, 160, 0, 0),
	CE(ZIMBABWE, ETSI1_WORLD, 0, ZW, 40, 160, 0, 0),
	CE(JAPAN, MKK5_MKKC, 0, JP, 40, 160, 0, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	...
	CE(ECUADOR, FCC3_WORLD, 0, EC, 40, 20, 0, 0),
	CE(EGYPT, ETSI3_WORLD, 0, EG, 40, 160, 0, 0),
	CE(EL_SALVADOR, FCC2_WORLD, 0, SV, 40, 20, 0, 0),
	...
	CE(UKRAINE, ETSI9_WORLD, 0, UA, 40, 160, 0, REGULATORY_PHYMODE_NO11AX),
	CE(UAE, FCC3_WORLD, 0, AE, 40, 160, 0, 0),
	CE(UNITED_KINGDOM, ETSI10_WORLD, ETSI2_6G, GB, 40, 160, 0, 0),
	CE(UNITED_STATES, FCC10_FCCA, FCC1_6G, US, 40, 160, 0, 0),
...
const struct country_code_to_reg_domain g_all_countries[] = {
	CE(AFGHANISTAN, ETSI1_WORLD, 0, AF, 40, 160, 0, 0),
	CE(ALAND_ISLANDS, FCC3_WORLD, 0, AX, 40, 160, 0, 0),
	CE(ALBANIA, ETSI9_WORLD, 0, AL, 40, 160, 0, 0),
	CE(ALGERIA, ETSI1_WORLD, 0, DZ, 40, 160, 0, 0),
	CE(AMERICAN_SAMOA, FCC3_FCCA, 0, AS, 40, 160, 0, 0),
	CE(ANDORRA, ETSI3_WORLD, 0, AD, 40, 160, 0, 0),
	CE(ANGUILLA, ETSI13_FCCA, 0, AI, 40, 160, 0, 0),
	CE(ANTIGUA_AND_BARBUDA, ETSI13_WORLD, 0, AG, 40, 160, 0, 0),
	CE(ARGENTINA, APL17_ETSIC, 0, AR, 40, 160, 0, 0),
	CE(ARMENIA, ETSI4_WORLD, 0, AM, 40, 20, 0, 0),
	CE(ARUBA, ETSI13_WORLD, 0, AW, 40, 160, 0, 0),
	CE(AUSTRALIA, FCC6_WORLD, 0, AU, 40, 160, 0, 0),
	CE(AUSTRIA, ETSI9_WORLD, 0, AT, 40, 160, 0, 0),
	CE(AZERBAIJAN, ETSI9_WORLD, 0, AZ, 40, 160, 0, 0),
	CE(BAHAMAS, FCC3_FCCA, 0, BS, 40, 160, 0, 0),
	CE(BAHRAIN, APL15_WORLD, 0, BH, 40, 20, 0, 0),
	CE(BANGLADESH, APL6_WORLD, 0, BD, 40, 160, 0, 0),
	CE(BARBADOS, FCC2_WORLD, 0, BB, 40, 160, 0, 0),
	CE(BELARUS, ETSI1_WORLD, 0, BY, 40, 160, 0, REGULATORY_PHYMODE_NO11AX),
	CE(BELGIUM, ETSI9_WORLD, 0, BE, 40, 160, 0, 0),
	CE(BELIZE, ETSI9_WORLD, 0, BZ, 40, 160, 0, 0),
	CE(BERMUDA, FCC3_FCCA, 0, BM, 40, 160, 0, 0),
	CE(BHUTAN, ETSI1_WORLD, 0, BT, 40, 160, 0, 0),
	CE(BOLIVIA, FCC3_FCCC, 0, BO, 40, 160, 0, 0),
	CE(BOSNIA_HERZ, ETSI9_WORLD, 0, BA, 40, 160, 0, 0),
	CE(BRAZIL, FCC3_ETSIC, 0, BR, 40, 160, 0, 0),
	CE(BRUNEI_DARUSSALAM, APL6_WORLD, 0, BN, 40, 160, 0, 0),
	CE(BULGARIA, ETSI9_WORLD, 0, BG, 40, 160, 0, 0),
	CE(BURKINA_FASO, FCC3_WORLD, 0, BF, 40, 160, 0, 0),
	CE(CAMBODIA, ETSI8_WORLD, 0, KH, 40, 160, 0, 0),
	CE(CAMEROON, ETSI9_WORLD, 0, CM, 40, 160, 0, 0),
	CE(CANADA, FCC6_FCCA, 0, CA, 40, 160, 0, 0),
	CE(CAYMAN_ISLANDS, FCC3_FCCA, 0, KY, 40, 160, 0, 0),
	CE(CENTRAL_AFRICA_REPUBLIC, FCC3_WORLD, 0, CF, 40, 40, 0, 0),
	CE(CHAD, ETSI1_WORLD, 0, TD, 40, 160, 0, 0),
	CE(CHILE, FCC3_FCCC, 0, CL, 40, 160, 0, 0),
	CE(CHINA, APL14_WORLD, 0, CN, 40, 160, 0, 0),
	CE(CHRISTMAS_ISLAND, FCC3_WORLD, 0, CX, 40, 160, 0, 0),
	CE(COLOMBIA, FCC10_FCCC, 0, CO, 40, 160, 0, 0),
	CE(COOK_ISLANDS, FCC3_WORLD, 0, CK, 40, 160, 0, 0),
	CE(COSTA_RICA, FCC3_FCCC, 0, CR, 40, 160, 0, 0),
	CE(COTE_DIVOIRE, ETSI1_WORLD, 0, CI, 40, 160, 0, 0),
	CE(CROATIA, ETSI9_WORLD, 0, HR, 40, 160, 0, 0),
	CE(CYPRUS, ETSI9_WORLD, 0, CY, 40, 160, 0, 0),
	CE(CZECH, ETSI9_WORLD, 0, CZ, 40, 160, 0, 0),
	CE(DENMARK, ETSI9_WORLD, 0, DK, 40, 160, 0, 0),
	CE(DOMINICA, FCC2_FCCA, 0, DM, 40, 160, 0, 0),
	CE(DOMINICAN_REPUBLIC, FCC3_FCCC, 0, DO, 40, 160, 0, 0),
	CE(ECUADOR, FCC3_FCCC, 0, EC, 40, 20, 0, 0),
	CE(EGYPT, ETSI8_WORLD, 0, EG, 40, 160, 0, 0),
	CE(EL_SALVADOR, FCC3_WORLD, 0, SV, 40, 20, 0, 0),
	CE(ESTONIA, ETSI9_WORLD, 0, EE, 40, 160, 0, 0),
	CE(ETHIOPIA, ETSI1_WORLD, 0, ET, 40, 160, 0, 0),
	CE(FALKLAND_ISLANDS, ETSI13_WORLD, 0, FK, 40, 160, 0, 0),
	CE(FAROE_ISLANDS, ETSI13_WORLD, 0, FO, 40, 160, 0, 0),
	CE(FINLAND, ETSI9_WORLD, 0, FI, 40, 160, 0, 0),
	CE(FRANCE, ETSI9_WORLD, 0, FR, 40, 160, 0, 0),
	CE(FRENCH_GUIANA, ETSI13_WORLD, 0, GF, 40, 160, 0, 0),
	CE(FRENCH_POLYNESIA, ETSI8_WORLD, 0, PF, 40, 160, 0, 0),
	CE(FRENCH_SOUTHERN_TERRITORIES, ETSI13_WORLD, 0, TF, 40, 160, 0, 0),
	CE(GEORGIA, ETSI9_WORLD, 0, GE, 40, 160, 0, 0),
	CE(GERMANY, ETSI9_WORLD, 0, DE, 40, 160, 0, 0),
	CE(GHANA, ETSI1_WORLD, 0, GH, 40, 160, 0, 0),
	CE(GIBRALTAR, ETSI1_WORLD, 0, GI, 40, 160, 0, 0),
	CE(GREECE, ETSI9_WORLD, 0, GR, 40, 160, 0, 0),
	CE(GREENLAND, ETSI8_WORLD, 0, GL, 40, 160, 0, 0),
	CE(GRENADA, FCC3_WORLD, 0, GD, 40, 160, 0, 0),
	CE(GUADELOUPE, ETSI1_WORLD, 0, GP, 40, 160, 0, 0),
	CE(GUAM, FCC3_WORLD, 0, GU, 40, 160, 0, 0),
	CE(GUATEMALA, FCC3_FCCC, 0, GT, 40, 160, 0, 0),
	CE(GUERNSEY, ETSI13_WORLD, 0, GG, 40, 160, 0, 0),
	CE(GUYANA, ETSI1_WORLD, 0, GY, 40, 160, 0, 0),
	CE(HAITI, FCC3_FCCA, 0, HT, 40, 160, 0, 0),
	CE(HEARD_ISLAND_AND_MCDONALD_ISLANDS, FCC6_WORLD, 0, HM, 40, 160, 0, 0),
	CE(HOLY_SEE, ETSI1_WORLD, 0, VA, 40, 160, 0, 0),
	CE(HONDURAS, FCC10_FCCC, 0, HN, 40, 160, 0, 0),
	CE(HONG_KONG, FCC3_WORLD, 0, HK, 40, 160, 0, 0),
	CE(HUNGARY, ETSI9_WORLD, 0, HU, 40, 160, 0, 0),
	CE(ICELAND, ETSI9_WORLD, 0, IS, 40, 160, 0, 0),
	CE(INDIA, APL19_ETSIC, 0, IN, 40, 160, 0, 0),
	CE(INDONESIA, APL2_ETSID, 0, ID, 40, 80, 0, 0),
	CE(IRAQ, ETSI9_WORLD, 0, IQ, 40, 160, 0, 0),
	CE(IRELAND, ETSI9_WORLD, 0, IE, 40, 160, 0, 0),
	CE(ISLE_OF_MAN, ETSI13_WORLD, 0, IM, 40, 160, 0, 0),
	CE(ISRAEL, ETSI3_WORLD, 0, IL, 40, 160, 0, 0),
	CE(ITALY, ETSI9_WORLD, 0, IT, 40, 160, 0, 0),
	CE(JAMAICA, FCC13_WORLD, 0, JM, 40, 160, 0, 0),
	CE(JERSEY, ETSI13_WORLD, 0, JE, 40, 160, 0, 0),
	CE(JORDAN, APL4_WORLD, 0, JO, 40, 160, 0, 0),
	CE(KAZAKHSTAN, MKK5_MKKC, 0, KZ, 40, 160, 0, 0),
	CE(KENYA, ETSI12_WORLD, 0, KE, 40, 160, 0, 0),
	CE(KOREA_ROC, APL9_MKKC, APL1_6G, KR, 40, 160, 0, 0),
	CE(KUWAIT, ETSI9_WORLD, 0, KW, 40, 160, 0, 0),
	CE(LATVIA, ETSI9_WORLD, 0, LV, 40, 160, 0, 0),
	CE(LEBANON, FCC3_WORLD, 0, LB, 40, 160, 0, 0),
	CE(LESOTHO, ETSI1_WORLD, 0, LS, 40, 160, 0, 0),
	CE(LIECHTENSTEIN, ETSI1_WORLD, 0, LI, 40, 160, 0, 0),
	CE(LITHUANIA, ETSI9_WORLD, 0, LT, 40, 160, 0, 0),
	CE(LUXEMBOURG, ETSI9_WORLD, 0, LU, 40, 160, 0, 0),
	CE(MACAU, FCC3_WORLD, 0, MO, 40, 160, 0, 0),
	CE(MACEDONIA, ETSI9_WORLD, 0, MK, 40, 160, 0, 0),
	CE(MALAWI, ETSI8_WORLD, 0, MW, 40, 160, 0, 0),
	CE(MALAYSIA, FCC11_WORLD, 0, MY, 40, 160, 0, 0),
	CE(MALDIVES, APL9_WORLD, 0, MV, 40, 160, 0, 0),
	CE(MALTA, ETSI9_WORLD, 0, MT, 40, 160, 0, 0),
	CE(MARSHALL_ISLANDS, FCC3_WORLD, 0, MH, 40, 160, 0, 0),
	...
	CE(MEXICO, FCC3_ETSIC, 0, MX, 40, 160, 0, 0),
	CE(MICRONESIA, FCC3_FCCA, 0, FM, 40, 160, 0, 0),
	CE(MOLDOVA, ETSI9_WORLD, 0, MD, 40, 160, 0, 0),
	CE(MONACO, ETSI1_WORLD, 0, MC, 40, 160, 0, 0),
	CE(MONGOLIA, FCC3_WORLD, 0, MN, 40, 160, 0, 0),
	CE(MONTENEGRO, ETSI9_WORLD, 0, ME, 40, 160, 0, 0),
	CE(MONTSERRAT, ETSI13_WORLD, 0, MS, 40, 160, 0, 0),
	CE(MOROCCO, ETSI3_WORLD, 0, MA, 40, 160, 0, 0),
	CE(MYANMAR, ETSI8_WORLD, 0, MM, 40, 160, 0, 0),
	CE(NAMIBIA, APL20_WORLD, 0, NA, 40, 160, 0, 0),
	CE(NEPAL, APL9_WORLD, 0, NP, 40, 160, 0, 0),
	CE(NETHERLANDS, ETSI9_WORLD, 0, NL, 40, 160, 0, 0),
	CE(NETHERLANDS_ANTILLES, ETSI13_WORLD, 0, AN, 40, 160, 0, 0),
	CE(NEW_CALEDONIA, ETSI13_WORLD, 0, NC, 40, 160, 0, 0),
	CE(NEW_ZEALAND, FCC3_ETSIC, 0, NZ, 40, 160, 0, 0),
	CE(NIGERIA, APL8_WORLD, 0, NG, 40, 160, 0, 0),
	CE(NORTHERN_MARIANA_ISLANDS, FCC3_FCCA, 0, MP, 40, 160, 0, 0),
	CE(NICARAGUA, FCC3_WORLD, 0, NI, 40, 160, 0, 0),
	CE(NIUE, ETSI13_WORLD, 0, NU, 40, 160, 0, 0),
	CE(NORFOLK_ISLAND, FCC6_WORLD, 0, NF, 40, 160, 0, 0),
	CE(NORWAY, ETSI9_WORLD, 0, NO, 40, 160, 0, 0),
	CE(OMAN, ETSI1_WORLD, 0, OM, 40, 160, 0, 0),
	CE(PAKISTAN, APL1_ETSIC, 0, PK, 40, 160, 0, 0),
	CE(PALAU, FCC3_FCCA, 0, PW, 40, 160, 0, 0),
	CE(PANAMA, FCC10_FCCC, 0, PA, 40, 160, 0, 0),
	CE(PAPUA_NEW_GUINEA, FCC3_WORLD, 0, PG, 40, 160, 0, 0),
	CE(PARAGUAY, FCC3_FCCC, 0, PY, 40, 160, 0, 0),
	CE(PERU, FCC3_FCCC, 0, PE, 40, 160, 0, 0),
	CE(PHILIPPINES, FCC3_WORLD, 0, PH, 40, 160, 0, 0),
	CE(POLAND, ETSI9_WORLD, 0, PL, 40, 160, 0, 0),
	CE(PORTUGAL, ETSI9_WORLD, 0, PT, 40, 160, 0, 0),
	CE(PUERTO_RICO, FCC10_FCCA, 0, PR, 40, 160, 0, 0),
	CE(QATAR, ETSI13_WORLD, 0, QA, 40, 160, 0, 0),
	CE(REUNION, ETSI9_WORLD, 0, RE, 40, 160, 0, 0),
	CE(ROMANIA, ETSI9_WORLD, 0, RO, 40, 160, 0, 0),
	CE(RUSSIA, ETSI11_WORLD, 0, RU, 40, 160, 0, REGULATORY_PHYMODE_NO11AX),
	CE(RWANDA, FCC3_WORLD, 0, RW, 40, 160, 0, 0),
	CE(SAINT_BARTHELEMY, ETSI1_WORLD, 0, BL, 40, 160, 0, 0),
	...
	CE(SAN_MARINO, FCC3_FCCA, 0, SM, 40, 160, 0, 0),
	CE(SAO_TOME_AND_PRINCIPE, FCC3_WORLD, 0, ST, 40, 160, 0, 0),
	CE(SAUDI_ARABIA, ETSI8_WORLD, 0, SA, 40, 160, 0, 0),
	CE(SENEGAL, ETSI3_WORLD, 0, SN, 40, 160, 0, 0),
	CE(SERBIA, ETSI9_WORLD, 0, RS, 40, 160, 0, 0),
	CE(SINGAPORE, FCC3_WORLD, 0, SG, 40, 160, 0, 0),
	CE(SINT_MAARTEN, ETSI13_WORLD, 0, SX, 40, 160, 0, 0),
	CE(SLOVAKIA, ETSI9_WORLD, 0, SK, 40, 160, 0, 0),
	CE(SLOVENIA, ETSI9_WORLD, 0, SI, 40, 160, 0, 0),
	CE(SOUTH_AFRICA, FCC10_WORLD, 0, ZA, 40, 160, 0, 0),
	CE(SPAIN, ETSI9_WORLD, 0, ES, 40, 160, 0, 0),
	CE(SURINAME, ETSI1_WORLD, 0, SR, 40, 160, 0, 0),
	CE(SRI_LANKA, FCC3_WORLD, 0, LK, 40, 20, 0, 0),
	CE(SVALBARD_AND_JAN_MAYEN, FCC6_WORLD, 0, SJ, 40, 160, 0, 0),
	CE(SWEDEN, ETSI9_WORLD, 0, SE, 40, 160, 0, 0),
	CE(SWITZERLAND, ETSI9_WORLD, 0, CH, 40, 160, 0, 0),
	CE(TAIWAN, FCC10_FCCA, 0, TW, 40, 160, 0, 0),
	CE(TANZANIA, APL1_WORLD, 0, TZ, 40, 160, 0, 0),
	CE(THAILAND, FCC3_WORLD, 0, TH, 40, 160, 0, 0),
	CE(TOGO, ETSI1_WORLD, 0, TG, 40, 40, 0, 0),
	CE(TRINIDAD_Y_TOBAGO, FCC3_WORLD, 0, TT, 40, 160, 0, 0),
	CE(TUNISIA, ETSI14_WORLD, 0, TN, 40, 160, 0, 0),
	CE(TURKEY, ETSI9_WORLD, 0, TR, 40, 160, 0, 0),
	CE(TURKS_AND_CAICOS, FCC3_WORLD, 0, TC, 40, 160, 0, 0),
	CE(UGANDA, ETSI10_FCCA, 0, UG, 40, 160, 0, 0),
	CE(UKRAINE, ETSI9_WORLD, 0, UA, 40, 160, 0, REGULATORY_PHYMODE_NO11AX),
	CE(UAE, FCC3_WORLD, 0, AE, 40, 160, 0, 0),
	CE(UNITED_KINGDOM, ETSI9_WORLD, ETSI2_6G, GB, 40, 160, 0, 0),
	CE(UNITED_STATES, FCC3_FCCA, FCC1_6G, US, 40, 160, 0, 0),
	CE(UNITED_STATES_MINOR_OUTLYING_ISLANDS, FCC3_FCCA, 0, UM, 40, 160, 0,
	   0),
	CE(URUGUAY, FCC3_FCCC, 0, UY, 40, 160, 0, 0),
	CE(UZBEKISTAN, ETSI1_WORLD, 0, UZ, 40, 160, 0, 0),
	CE(VANUATU, FCC3_WORLD, 0, VU, 40, 160, 0, 0),
	CE(VENEZUELA, FCC2_ETSIC, 0, VE, 40, 160, 0, 0),
	CE(VIET_NAM, FCC3_WORLD, 0, VN, 40, 80, 0, 0),
	CE(VIRGIN_ISLANDS, FCC14_WORLD, 0, VI, 40, 160, 0, 0),
	...
	CE(JAPAN, MKK5_MKKC, 0, JP, 40, 160, 0, 0),
	CE(XA, MKK5_MKKA, 0, XA, 40, 160, 0, 0),
	CE(ANGOLA, ETSI9_WORLD, 0, AO, 40, 160, 0, 0),
	CE(LAO, ETSI8_WORLD, 0, LA, 40, 160, 0, 0),
	CE(BENIN, ETSI9_WORLD, 0, BJ, 40, 160, 0, 0),
	CE(BOTSWANA, ETSI1_WORLD, 0, BW, 40, 160, 0, 0),
	CE(CONGO, ETSI1_WORLD, 0, CD, 40, 160, 0, 0),
	CE(FIJI, ETSI8_WORLD, 0, FJ, 40, 160, 0, 0),
	CE(MADAGASCAR, ETSI1_WORLD, 0, MG, 40, 160, 0, 0),
	CE(ZAMBIA, ETSI8_WORLD, 0, ZM, 40, 160, 0, 0),
};
#endif
#endif
...
const struct regdomain regdomains_2g[] = {
	...
	[FCCC] = {CTL_FCC, DFS_UNINIT_REGION, 0, 40, 0, 1, {CHAN_1_13_1} },
...
const struct regdomain regdomains_5g[] = {
	...
	[FCC4] = {CTL_FCC, DFS_FCC_REGION, 2, 160, 6, 1, {CHAN_4940_4990_1} },
	...
	[FCC10] = {CTL_FCC, DFS_FCC_REGION, 2, 160, 0, 4, {CHAN_5170_5250_4,
							   CHAN_5250_5330_7,
							   CHAN_5490_5710_1,
							   CHAN_5735_5835_2} },
	...
	[FCC14] = {CTL_FCC, DFS_UNINIT_REGION, 2, 160, 0, 3, {CHAN_5170_5250_4,
							      CHAN_5250_5330_10,
							      CHAN_5735_5835_2} },
	...
	[ETSI8] = {CTL_ETSI, DFS_UNINIT_REGION, 20, 160, 0, 4, {CHAN_5170_5250_2,
							 CHAN_5250_5330_5,
							 CHAN_5490_5730_3,
							 CHAN_5735_5835_2} },
	...
	[ETSI10] = {CTL_ETSI, DFS_ETSI_REGION, 10, 160, 0, 3, {CHAN_5270_5330_1,
							CHAN_5490_5730_7,
							CHAN_5735_5835_1} },
	...
	[ETSI14] = {CTL_ETSI, DFS_ETSI_REGION, 2, 160, 0, 3, {CHAN_5170_5250_2,
							 CHAN_5250_5330_1,
							 CHAN_5490_5650_2} },
	...
	[APL2] = {CTL_ETSI, DFS_UNINIT_REGION, 2, 20, 0, 3, {CHAN_5170_5250_2,
							 CHAN_5250_5330_1,
							 CHAN_5735_5815_4} },

	[APL4] = {CTL_ETSI, DFS_UNINIT_REGION, 2, 80, 0, 3, {CHAN_5170_5250_2,
							 CHAN_5490_5710_1,
							 CHAN_5735_5835_1} },
	...
	[APL17] = {CTL_FCC, DFS_UNINIT_REGION, 2, 160, 0, 4, {CHAN_5170_5250_2,
							 CHAN_5250_5330_8,
							 CHAN_5490_5710_7,
							 CHAN_5735_5835_7} },

	[APL19] = {CTL_FCC, DFS_FCC_REGION, 2, 160, 0, 3, {CHAN_5170_5250_4,
							 CHAN_5250_5330_7,
							 CHAN_5735_5835_3} },
	...
	[APL23] = {CTL_ETSI, DFS_UNINIT_REGION, 2, 160, 0, 3, {CHAN_5170_5250_7,
							 CHAN_5250_5330_11,
							 CHAN_5735_5835_3} },
