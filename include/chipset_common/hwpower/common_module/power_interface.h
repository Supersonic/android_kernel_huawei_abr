...
enum power_if_sysfs_type {
	...
	POWER_IF_SYSFS_IBUS,
	POWER_IF_SYSFS_VBUS,
	POWER_IF_SYSFS_DISABLE_FUNCTION,
	POWER_IF_SYSFS_END,
};
...
enum power_if_op_type {
	...
	POWER_IF_OP_TYPE_SC4, /* sc4 */
	POWER_IF_OP_TYPE_MAINSC4, /* mainsc4 */
	POWER_IF_OP_TYPE_AUXSC4, /* auxsc4 */
...
struct power_if_ops {
	...
	int (*set_disable_func)(unsigned int value);
	int (*get_disable_func)(unsigned int *value);
};
