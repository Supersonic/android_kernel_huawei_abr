...
enum
{
	LASER_CMD_DIR_FLAG_SHIT = 30,
	/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
	LASER_CMD_RESP_FLAG_SHIT = 28,
	LASER_CMD_OUT_LEN_SHIT = 22,
	LASER_CMD_IN_LEN_SHIT = 16,
	LASER_CMD_OPCODE_SHIT = 0,
	/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
...
enum {
	...
	HWLASER_ST_L1_VERSION,
	HWLASER_VI_I0_VERSION,
	HWLASER_AMS_I0_VERSION,
	HWLASER_MAX_VERSION,
};
...
typedef struct _tag_hwlaser_xtalk_histogram_shape {
	uint8_t  zone_id;
	uint32_t time_stamp;
	uint8_t  PRM_00019;//XTALK_SHAPE_FIRST_BIN
	uint8_t  PRM_00020;//XTALK_SHAPE_BUFFER_SIZE
	uint8_t  PRM_00021;//XTALK_SHAPE_NUMBER_OF_BINS
	...
	uint16_t PRM_00022;//XTALK_SHAPE_FASTOSC_FREQUENCY
...
} hwlaser_calibration_data_L3;

typedef struct _tag_hwlaser_calibration_data_L2 { /* ams */
	unsigned int xtalk;
...
typedef struct __tag_hwlaser_calibration_data {
	...
	union laser_calibration_data{
		hwlaser_calibration_data_L1  dataL1; /* st */
		hwlaser_calibration_data_L2  dataL2; /* ams */
		hwlaser_calibration_data_L3  dataL3; /* vi53xx */
	} u;
...
#define hwlaser_DISTANCEMODE_SHORT             ((hwlaser_DistanceModes)  1)
#define hwlaser_DISTANCEMODE_MEDIUM            ((hwlaser_DistanceModes)  2)
#define hwlaser_DISTANCEMODE_LONG              ((hwlaser_DistanceModes)  3)
/** @} hwlaser_define_DistanceModes_group */
...
typedef struct _tag_hwlaser_result_t {
	uint32_t distance;
	uint32_t status;
} hwlaser_RangingData_simple;

typedef struct _tag_hwlaser_ranging_data
{
	union hwlaser_measurement_data
	{
		hwlaser_multiRangingData_t   data; /* vl53l1 */
		hwlaser_RangingData_simple   data_1; /* tof8801/vi5300 */
	} u;
 ...
 ** -----------------L1 LASER modification--------------------------**
  * param1 is offset calibration mode. Parameter is either:
  *        - hwlaser_OFFSETCALIBRATIONMODE_STANDARD
  *        - hwlaser_OFFSETCALIBRATIONMODE_PRERANGE_ONLY
  *        - hwlaser_OFFSETCALIBRATIONMODE_MULTI_ZONE (deprecated)
  * param2 is target distance in mm.
  * param3 is target reflectance in percent. Parameter is of type uint32_t.
  *
  * Note that hwlaser_OFFSETCALIBRATIONMODE_MULTI_ZONE usage is deprecated. Per
  * zone offset calibration should use hwlaser_CALIBRATION_OFFSET_PER_ZONE
  * instead.
 ...
 * param1, param2 and param3 not use
 */
#define HWLASER_CALIBRATION_OFFSET_SIMPLE            4
...
typedef struct _tag_hwlaser_ioctl_perform_calibration {
	...
	** @li @ref HWLASER_CALIBRATION_REF_SPAD // L1
	** @li @ref HWLASER_CALIBRATION_CROSSTALK
	** @li @ref HWLASER_CALIBRATION_OFFSET
	** @li @ref HWLASER_CALIBRATION_REFERENCE //L0
	** @li @ref HWLASER_CALIBRATION_SPAD //L0
	**/
	uint32_t param1;
