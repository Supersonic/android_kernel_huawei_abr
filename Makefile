...
lcd_kit: FORCE
	...
	cd ${LCD_KIT_TOOLPATH};perl ./lcd_kit_parser.pl $(TARGET_PRODUCT) $(DTS_TYPE) $(shell pwd)/${config_generate_dir}; \
	perl ./lcd_kit_parser.pl ${TARGET_PRODUCT} effect $(LCD_KIT_DPD_FILE_PATH)
