...
struct calib_oeminfo {
	int calib_value[8];
	float calib_value_f[8];
};
...
#define AW882XX_IOCTL_GET_RE				_IOWR(AW882XX_IOCTL_MAGIC, 17, struct calib_oeminfo)
...
struct aw_cali {
	...
	uint8_t get_re_f0;//1:get_re;2:get_f0;others:get nothing
	uint8_t is_cali_started;
	int32_t cali_re;
	int32_t cali_f0;
