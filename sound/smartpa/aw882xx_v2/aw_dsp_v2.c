...
#define AFE_PORT_ID_AWDSP_TX	(AFE_PORT_ID_PRIMARY_MI2S_TX)	/*INDEX_AFE_PORT_ID_PRIMARY_MI2S_TX*/
#define AFE_PORT_ID_AWDSP_RX	(AFE_PORT_ID_PRIMARY_MI2S_RX)	/*INDEX_AFE_PORT_ID_PRIMARY_MI2S_RX*/
