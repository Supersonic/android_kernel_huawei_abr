...
#include "aw_pid_1852_reg_v2.h"
#include "aw_pid_2032_reg_v2.h"
#include "aw_log_v2.h"
	...
	unsigned char reg_addr, unsigned int reg_data)
{
	...
	return aw882xx_i2c_write_v2(aw882xx, reg_addr, reg_data);
}
	...
	unsigned char reg_addr, unsigned int *reg_data)
{
	...
	return aw882xx_i2c_read_v2(aw882xx, reg_addr, reg_data);
}
...
static int aw_pid_1852_set_volume(struct aw_device *aw_dev, unsigned int value)
{
	...
	/* cal real value */
	aw882xx_i2c_read_v2(aw882xx, AW_PID_1852_HAGCCFG4_REG, &reg_value);
	...
	/* write value */
	aw882xx_i2c_write_v2(aw882xx, AW_PID_1852_HAGCCFG4_REG, real_value);
	return 0;
}
...
static int aw_pid_2032_set_volume(struct aw_device *aw_dev, unsigned int value)
{
	...
	/* cal real value */
	aw882xx_i2c_read_v2(aw882xx, AW_PID_2032_SYSCTRL2_REG, &reg_value);
	...
	/* write value */
	aw882xx_i2c_write_v2(aw882xx, AW_PID_2032_SYSCTRL2_REG, real_value);
	return 0;
}
